...
COMPILE_OPTIONS=("--disable-aot" "--aot-rtc" "--aot-rtl" "--aot-compile-all --aot-pressure=0.1" "--aot-compile-all --aot-pressure=0.3" "--aot-compile-all --aot-pressure=0.5" "--aot-compile-all --aot-pressure=0.7")
...
do
    ...
    if [ $EXECUTABLE == "./build/src/aot/wabtaot-paper" ] ; then
        REPORT="results-wabtaotpaper-nil-nil-nil-nil-nil"
        ...
        do
            ...
            do
                ...
                if [[ "$COMPILE_OPTION" == "--disable-aot" ]] ; then
                    ...
                    REPORT="results-eminterp-nil-nil-nil-nil-$JIT_OPTION_SUFFIX"
                    export REPORT
                    bash wabtaot-private-additions/scripts/test_time_polybench-generic-aot.sh
                else
                    ...
                    do
                        ...
                        do
                            ...
                            REPORT="results"$EXECUTABLE_SUFFIX$CALLING_SUFFIX$COMPILE_OPTION_SUFFIX$ANALYSIS_OPTION_SUFFIX-$JIT_OPTION_SUFFIX
                            export REPORT
                            bash wabtaot-private-additions/scripts/test_time_polybench-generic-aot.sh
